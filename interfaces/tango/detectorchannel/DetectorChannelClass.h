/*----- PROTECTED REGION ID(DetectorChannelClass.h) ENABLED START -----*/
//=============================================================================
//
// file :        DetectorChannelClass.h
//
...
#ifndef DetectorChannelClass_H
#define DetectorChannelClass_H
...
/*----- PROTECTED REGION END -----*/	//	DetectorChannelClass.h


namespace DetectorChannel_ns
{
/*----- PROTECTED REGION ID(DetectorChannelClass::classes for dynamic creation) ENABLED START -----*/


/*----- PROTECTED REGION END -----*/	//	DetectorChannelClass::classes for dynamic creation
...
public:
	...
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<DetectorChannel *>(dev))->read_active(att);}
	virtual void write(Tango::DeviceImpl *dev,Tango::WAttribute &att)
		{(static_cast<DetectorChannel *>(dev))->write_active(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<DetectorChannel *>(dev))->is_active_allowed(ty);}
};
...
/**
 *	The DetectorChannelClass singleton definition
 */

#ifdef _TG_WINDOWS_
class __declspec(dllexport)  DetectorChannelClass : public MLZDevice_ns::MLZDeviceClass
#else
class DetectorChannelClass : public MLZDevice_ns::MLZDeviceClass
#endif
{
	/*----- PROTECTED REGION ID(DetectorChannelClass::Additionnal DServer data members) ENABLED START -----*/


	/*----- PROTECTED REGION END -----*/	//	DetectorChannelClass::Additionnal DServer data members
	...
	public:
		...
		~DetectorChannelClass();
		Tango::DbDatum	get_class_property(std::string &);
		Tango::DbDatum	get_default_device_property(std::string &);
		Tango::DbDatum	get_default_class_property(std::string &);

	protected:
		DetectorChannelClass(std::string &);

/*----- PROTECTED REGION ID(MLZDeviceClass.h) ENABLED START -----*/
//=============================================================================
//
// file :	MLZDeviceClass.h
//
// description : Include for the MLZDevice root class.
//	       This class is the singleton class for
//		the MLZDevice device class.
//	       It contains all properties and methods which the
//	       MLZDevice requires only once e.g. the commands.
//
...
#ifndef MLZDeviceClass_H
#define MLZDeviceClass_H

#include <tango.h>
#include "MLZDevice.h"


/*----- PROTECTED REGION END -----*/	//	MLZDeviceClass.h


namespace MLZDevice_ns
{
/*----- PROTECTED REGION ID(MLZDeviceClass::classes for dynamic creation) ENABLED START -----*/


/*----- PROTECTED REGION END -----*/	//	MLZDeviceClass::classes for dynamic creation
...
public:
	...
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<MLZDevice *>(dev))->read_version(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<MLZDevice *>(dev))->is_version_allowed(ty);}
};
...
/**
 *	The MLZDeviceClass singleton definition
 */

#ifdef _TG_WINDOWS_
class __declspec(dllexport)  MLZDeviceClass : public Tango::DeviceClass
#else
class MLZDeviceClass : public Tango::DeviceClass
#endif
{
	/*----- PROTECTED REGION ID(MLZDeviceClass::Additionnal DServer data members) ENABLED START -----*/


	/*----- PROTECTED REGION END -----*/	//	MLZDeviceClass::Additionnal DServer data members
